...
<section id="featured-cards" class="featured-cards-section scroll-section min-h-screen relative flex items-center justify-center overflow-hidden py-16">
    ...
    <div class="container mx-auto px-4 relative z-10">
        <div class="text-center mb-16">
            <h2 class="text-5xl md:text-7xl shine-effect animate-float-title font-bold text-white mb-10 opacity-0 transform translate-y-10 transition-all duration-700 section-title relative">
                Everything You Need
            </h2>
