...
<section id="featured-cards" class="featured-cards-section scroll-section min-h-screen relative flex items-center justify-center overflow-hidden py-16">
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="cards-container relative h-[600px] perspective-1000 flex items-center justify-center">
            <div class="card-wrapper absolute inset-0 flex items-center justify-center">
                <!-- Card 1 -->
                <div class="feature-card" data-card-index="0">
                    <div class="card-inner">
                        <div class="card-content-wrapper">
                            <div class="card-icon mb-6 rounded-xl flex items-center justify-center w-16 h-16">
                                <i class="fa fa-comments text-2xl text-white"></i>
                            </div>
                            <h3 class="card-title text-2xl font-bold text-white mb-5">Text Chat</h3>
                ...
                <!-- Card 2 -->
                <div class="feature-card" data-card-index="1">
                    <div class="card-inner">
                        <div class="card-content-wrapper">
                            <div class="card-icon mb-6 rounded-xl flex items-center justify-center w-16 h-16">
                                <i class="fa fa-headset text-2xl text-white"></i>
                            </div>
                            <h3 class="card-title text-2xl font-bold text-white mb-5">Voice Channels</h3>
                            <p class="card-description text-white/80">
                ...
                <!-- Card 3 (Center) -->
                <div class="feature-card" data-card-index="2">
                    <div class="card-inner">
                        <div class="card-content-wrapper">
                            <div class="card-icon mb-6 rounded-xl flex items-center justify-center w-16 h-16">
                                <i class="fa fa-users text-2xl text-white"></i>
                            </div>
                            <h3 class="card-title text-2xl font-bold text-white mb-5">Communities</h3>
                            <p class="card-description text-white/80">
                ...
                <!-- Card 4 -->
                <div class="feature-card" data-card-index="3">
                    <div class="card-inner">
                        <div class="card-content-wrapper">
                            <div class="card-icon mb-6 rounded-xl flex items-center justify-center w-16 h-16">
                                <i class="fa fa-shield-alt text-2xl text-white"></i>
                            </div>
                            <h3 class="card-title text-2xl font-bold text-white mb-5">Security</h3>
                            <p class="card-description text-white/80">
                ...
                <!-- Card 5 -->
                <div class="feature-card" data-card-index="4">
                    <div class="card-inner">
                        <div class="card-content-wrapper">
                            <div class="card-icon mb-6 rounded-xl flex items-center justify-center w-16 h-16">
                                <i class="fa fa-video text-2xl text-white"></i>
                            </div>
                            <h3 class="card-title text-2xl font-bold text-white mb-5">Video Chat</h3>
                            <p class="card-description text-white/80">
    ...
    <!-- Gradient circles in the background -->
    <div class="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-gradient-to-tr from-blue-500/20 to-purple-500/10 blur-3xl z-0 transform -translate-x-1/2 -translate-y-1/2"></div>
    <div class="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-gradient-to-tr from-indigo-500/15 to-purple-500/5 blur-3xl z-0"></div>
