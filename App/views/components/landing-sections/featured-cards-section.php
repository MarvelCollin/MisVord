...
<section id="featured-cards" class="featured-cards-section scroll-section min-h-screen relative flex items-center justify-center overflow-hidden py-16">
    ...
    <div class="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-gradient-to-tr from-blue-500/20 to-purple-500/10 blur-3xl z-0 transform -translate-x-1/2 -translate-y-1/2 animate-pulse-slow"></div>
    <div class="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-gradient-to-tr from-indigo-500/15 to-purple-500/5 blur-3xl z-0 animate-pulse-slow animation-delay-2000"></div>
    <div class="absolute top-2/3 right-1/3 w-64 h-64 rounded-full bg-gradient-to-tr from-purple-500/15 to-pink-500/10 blur-3xl z-0 animate-pulse-slow animation-delay-1000"></div>
