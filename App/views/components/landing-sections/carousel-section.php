    ...
    <div class="container mx-auto px-4 relative z-10">
        ...
        <div class="simple-book">
            <div class="book-content" id="bookContent">
                <div class="page book-cover active" data-page="0">
                    <div class="page-decoration"></div>
                    <h4>📖 Success Stories</h4>
                    <p>Click anywhere to explore how communities thrive on MisVord platform and discover amazing success stories</p>
                </div>
