...
<div id="voice-indicator" class="voice-ind-container fixed bottom-4 left-4 z-50 bg-[#1e1f22] max-h-[60px] text-white rounded-lg shadow-lg transform transition-all duration-300 scale-0 opacity-0 cursor-grab active:cursor-grabbing" style="display: none;">
    <div class="voice-ind-header px-3 py-2">
        <div class="voice-ind-main flex items-center justify-between gap-2">
            <div class="voice-ind-info flex items-center gap-2 cursor-grab active:cursor-grabbing">
