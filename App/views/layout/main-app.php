...
<body class="<?php echo $body_class ?? 'bg-gray-900'; ?> <?php echo isset($_SESSION['user_id']) ? 'authenticated' : ''; ?> <?php echo isset($data_page) && $data_page == 'settings-user' ? 'settings-user' : ''; ?>" <?php echo isset($body_attributes) ? $body_attributes : ''; ?>>
    <?php echo $content ?? ''; ?>
