    ...
    <div class="flex-1 flex">
        <div class="w-64 bg-discord-light border-r border-discord-dark">
            ...
            <nav class="mt-4">
                <ul>
                    <li>
                        <a href="?server_id=<?php echo $serverId; ?>&channel_id=<?php echo $channelId; ?>&section=overview" class="flex items-center p-3 text-discord-light-gray hover:bg-discord-dark-hover <?php echo $section === 'overview' ? 'bg-discord-dark-hover text-white' : ''; ?>">
                            Overview
                        </a>
                    </li>
                    <li>
                        <a href="?server_id=<?php echo $serverId; ?>&channel_id=<?php echo $channelId; ?>&section=permissions" class="flex items-center p-3 text-discord-light-gray hover:bg-discord-dark-hover <?php echo $section === 'permissions' ? 'bg-discord-dark-hover text-white' : ''; ?>">
                            Permissions
                        </a>
                    </li>
                    <li>
                        <a href="?server_id=<?php echo $serverId; ?>&channel_id=<?php echo $channelId; ?>&section=invites" class="flex items-center p-3 text-discord-light-gray hover:bg-discord-dark-hover <?php echo $section === 'invites' ? 'bg-discord-dark-hover text-white' : ''; ?>">
                            Invites
                        </a>
                    </li>
                    <li>
                        <a href="?server_id=<?php echo $serverId; ?>&channel_id=<?php echo $channelId; ?>&section=integrations" class="flex items-center p-3 text-discord-light-gray hover:bg-discord-dark-hover <?php echo $section === 'integrations' ? 'bg-discord-dark-hover text-white' : ''; ?>">
                            Integrations
                        </a>
                    </li>
                    <li class="mt-8">
