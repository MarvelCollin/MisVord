        ...
        try {
            ...
            if ($globalSequence) {
                ...
                return $this->success([
                    ...
                    'sync_type' => 'global',
                    'global_items_synced' => $categoriesUpdated + $channelsUpdated,
                    'categories_synced' => $categoriesUpdated,
                    'channels_synced' => $channelsUpdated
                ]);
            } else {
                $categoryPosition = 1;
                foreach ($categories as $category) {
            ...
            return $this->serverError('Failed to sync positions');
        }
    }
}